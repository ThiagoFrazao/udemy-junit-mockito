...
import br.udemy.business.CourseBusiness;
...
class MockitoInjectMockTest {
    ...
    @Captor
    static ArgumentCaptor<Course> captorCourse;
    ...
    void testArgumentCapture() {
        Course course = new Course("CursoNovo","GERENCIADOR");
        courseBusiness.adicionarNovoCurso(course);
        BDDMockito.then(courseService).should().adicionarCurso(captorCourse.capture());
        Assertions.assertEquals(course, captorCourse.getValue());
    }
